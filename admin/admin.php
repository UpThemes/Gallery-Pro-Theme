...
function upfw_permissions_error(){
	echo '<div id="message" class="error"><p>' . __('It looks like your uploads folder does not have proper permissions. Please set [wordpress-install]/wp-content/uploads/ to 777 (read/write/execute).','upfw') . '</p></div>';
	return false;
}
...
function up_defaults(){
	...
	if(!get_option('up_themes_'.UPTHEMES_SHORT_NAME) && $_GET['page']!="upthemes"):
                ...
                function up_activation() {
                    do_action('up_activation');
                }
