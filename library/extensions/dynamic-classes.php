...
function thematic_body_class( $print = true ) {
	...
	if ( is_single() ) {
		...
		// Special class for post templates	
		if(get_post_meta($postID,'custom_post_template',true)){
			$c[] = 'post-temp-' . sanitize_title_with_dashes(strtolower(get_post_meta($postID,'custom_post_template',true)));
		}
